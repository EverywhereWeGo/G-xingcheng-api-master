...
public class HbaseUtil2 {
    ...
    public static void main(String[] args) throws IOException {
     /*   createTable("t2",new String[]{"cf1","cf2"});
    	...
    	listTables();
        getData("OfflineUserProfileV3.4", "ffd4c4ae-44a1-4446-a146-12ec34d6ef51", "up", "q1");
        //scanData("t2", "rw1", "rw2");
/*        deleRow("t2","rw1","cf1","q1");
    ...
    public static void init(){
        ...
        configuration.set("hbase.zookeeper.quorum",Constants.ZK_HOST);
  ...
  //根据rowkey查找数据
    public static Map<String,String> getData(String tableName,String rowkey)throws  IOException{
        ...
        for(Cell cell:cells){
            ...
            String famcol = new String(CellUtil.cloneFamily(cell), "UTF-8") + ":" + new String(CellUtil.cloneQualifier(cell), "UTF-8");
            returnMap.put(famcol, new String(CellUtil.cloneValue(cell)));
        }
        table.close();
        close();
        return returnMap;
